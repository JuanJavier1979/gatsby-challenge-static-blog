...
![Tailwind Image](./undraw_tailwind_css_1egw.png)
...
Or add TailwindCSS utility classes into your HTML code. Let's add a container class to the main element in `src/components/layout.js` file.
